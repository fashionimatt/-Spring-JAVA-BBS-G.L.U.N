...
public interface BoardMapper {
	...
	// Statement으로 얻어낸 값을 keyProperty에 담는다는 명령문
	...
	@Select("select a1.content_idx, a1.content_subject, a2.user_name as content_writer_name, " + 
			"to_char(a1.content_date, 'yyyy-mm-dd hh24:mi') as content_date, a1.content_file " + 
			"from content_table a1, user_table a2 " + 
			"where a1.content_writer_idx = a2.user_idx " +
			"and a1.content_board_idx = #{board_info_idx} " +
			"order by a1.content_idx desc")
	//													RowBounds 클래스는 설정된 범위의 정보만 추출해서 가져온다.
